...
<body>
        ...
        <div class="container-lg position-relative p-0 px-lg-3" style="z-index: 9;">
            <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg">
                <a href="" class="navbar-brand">
                    <h1 class="m-0 text-primary"><span class="text-dark">TRAVEL</span>LING</h1>
                </a>
                    ...
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu border-0 rounded-0 m-0">
                                <a href="destination.php" class="dropdown-item">Category</a>
            ...
            <div class="row">
                <div class="col-lg-6" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="img/dm.jpeg" style="object-fit: cover;">
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="d-flex mb-4 mb-lg-0">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <p class="m-0">Harga sesuai budget yang anda miliki</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="d-flex mb-4 mb-lg-0">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <p class="m-0">Pelayanan yang kami berikan tentu akan membuat anda nyaman</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="d-flex mb-4 mb-lg-0">
                        ...
                        <div class="d-flex flex-column">
                            <h5 class="">Cakupan Se-Indonesia</h5>
                            <p class="m-0">Kami menyediakan seluruh tempat wisata yang ada di Indonesia</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <div class="text-center mb-3 pb-3">
                <h6 class="text-primary text-uppercase" style="letter-spacing: 5px;">Developer</h6>
                <h1>Our Developer</h1>
            </div>
            <div class="row">
                <div class="col-lg-3 col-md-4 col-sm-6 pb-2">
                    <div class="team-item bg-white mb-4">
                        ...
                        <div class="text-center py-4">
                            <h5 class="text-truncate">Aldi Pratama</h5>
                            <p class="m-0">Ketua Kelompok</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 pb-2">
                    <div class="team-item bg-white mb-4">
                        ...
                        <div class="text-center py-4">
                            <h5 class="text-truncate">Nurfadillah Insani</h5>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 pb-2">
                    <div class="team-item bg-white mb-4">
                        ...
                        <div class="text-center py-4">
                            <h5 class="text-truncate">Linda Handayani</h5>
                            <p class="m-0">Anggota</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6 pb-2">
                    <div class="team-item bg-white mb-4">
                        ...
                        <div class="text-center py-4">
                            <h5 class="text-truncate">Fawwaz Aziz</h5>
                            <p class="m-0">Anggota</p>
                        </div>
                    </div>
                </div>
